...
#         user_count = getattr(pattern, 'users', None) or \
#                      getattr(pattern, 'peak_users', None) or \
#                      getattr(pattern, 'max_users', None) or 10

#         spawn_rate = getattr(pattern, 'spawn_rate', None) or 1.0
...
#         logger.info(f"Starting test with {user_count} users, spawn rate: {spawn_rate}")
